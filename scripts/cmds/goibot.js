...
module.exports.onChat = async ({ message, event }) => {
  ...
  if (hh.startsWith("zuma") || hh.startsWith("jhuma")) {
    try {
      const ar = [
       ...
       "𝙰𝚌𝙲𝙲𝙰𝙷 𝙱𝙾𝙻𝙾 𝙰𝙼𝙺𝙴 𝙻𝙰𝙶𝙱𝙴 𝙽𝙰𝙺𝙸 𝚁𝚄𝚂𝚂𝙸𝙰𝙽 ?",
        ...
        "𝐙𝐮𝐦𝐚 না 𝐍𝐮𝐫𝐧𝐨𝐛𝐢𝐫 𝐁𝐨𝐰,বলো কারন আমি 𝐌𝐢𝐧𝐠𝐥𝐞 😌 ",
        " I love you tuna🥺🥶",
        "Tuma dew xanu😍😘 ",
      ...
      "Bolo Babu, তুমি কি আমাকে ভালোবাসো? 🙈💋 ",
       ...
       "bado maser kawwa police amar sawwa😞",
        ...
        "𝗮𝗺𝗶 𝐳𝐮𝐦𝐚 𝗻𝗮 𝗮𝗺𝗮𝗸𝗲 𝗯𝗯𝘆 𝗯𝗼𝗹𝗼 𝗯𝗯𝘆!!😘 ",
        "🍺 এই নাও জুস খাও..!𝗕𝗯𝘆 বলতে বলতে হাপায় গেছো না 🥲 ",
        "🍺 এই নাও জুস খাও..!𝗕𝗯𝘆 বলতে বলতে হাপায় গেছো না 🥲 ",
        "𝗛𝗶𝗶 𝗶 𝗮𝗺 𝐳𝐮𝐦𝐚 𝗰𝗮𝗻 𝗶 𝗵𝗲𝗹𝗽 𝘆𝗼𝘂!🤖 ",
      ...
      "Chup kor nunu kete demu bashi dakle😬",
        ...
        " 𝐙𝐮𝐦𝐚 না জানু,বলো কারন আমি সিংগেল 😌",
        " দূরে যাইয়া মুরি খাঁ, তোর কোনো কাজ কাম নাই, শুধু 𝐙𝐮𝐦𝐚 𝐙𝐮𝐦𝐚করিস  😒",
        "আম গাছে আম নাই ঢিল কেন মারো, তোমার সাথে প্রেম নাই Bby কেন ডাকো🥲 ",
        "𝘁𝗼𝗿 𝗻𝗮𝗻𝗶𝗿 𝗸𝗵𝗮𝗹𝗶 𝗴𝗵𝗼𝗿😒😒 ",
     "এই এই তোর পরীক্ষা কবে ? শুধু 𝐙𝐮𝐦𝐚 𝐙𝐮𝐦𝐚 𝗸𝗼𝗿𝗶𝘀 ",
    ...
    "আগে একটা গান বলো, ☹ নাহলে কথা বলবো না 🥺",
        ...
        "জান হাঙ্গা করবা-🙊😝🌻 ",
        "বেশি 𝐙𝐮𝐦𝐚 𝐙𝐮𝐦𝐚 করলে leave নিবো কিন্তু😒😒 ",
